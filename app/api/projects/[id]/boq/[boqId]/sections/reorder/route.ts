...
import { reorderBoqSections } from "@/lib/boq/mutations";
...
export async function POST(request: NextRequest, context: RouteContext) {
  ...
  const result = await reorderBoqSections(id, boqId, values);
  ...
  return apiSuccess("Sections reordered.", { id: result.id });
}
